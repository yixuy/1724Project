...
The chat application will support the retrieval of historical messages in each chat room.
This feature prevents any loss of messages due to refresh the browser or unexpected disconnections, providing a more reliable communication experience. Besides, this means that if users exit the application, they will still be able to retrieve previous messages upon their next login, as the messages will be reloaded from the database.
...
- Creating all the API using Actix-Web
